...
const Term = () => {
    ...
    return (
        <div className='container my-5'>
            <div className='py-5'>
                <div className='bg-light p-5 col-6 mx-auto text-center border border-secondary shadow'>
                <h1>利用規約</h1>
                <p className='mt-4 fs-5'>
                    この利用規約（以下，「本規約」といいます。）は，Avenu-E（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の
                    利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
                </p>
                </div>
                <div className='py-5'>
                    <div className='bg-light p-5 col-10 mx-auto border border-secondary position-relative shadow'>
                        {/* <!-- ########## 第１条 ########## --> */}
                        <h1 className='text-center'>第１条（適用）</h1>
                        <ol className='mt-4 fs-5'>
                        ...
                        {/* <!-- ########## 第２条 ########## --> */}
                        <h1 className='text-center pt-5'>第２条（利用登録）</h1>
                        <ol className='mt-4 fs-5'>
                        ...
                        {/* <!-- ########## 第３条 ########## --> */}
                        <h1 className='text-center pt-5'>第３条（ユーザーIDおよびパスワードの管理）</h1>
                        <ol className='mt-4 fs-5'>
                        ...
                        {/* <!-- ########## 第４条 ########## --> */}
                        <h1 className='text-center pt-5'>第４条（利用料金および支払方法）</h1>
                        <ol className='mt-4 fs-5'>
                        ...
                        {/* <!-- ########## 第５条 ########## --> */}
                        <h1 className='text-center pt-5'>第５条（禁止事項）</h1>
                        <p className='text-center pt-4'>ユーザーは，本サービスの利用にあたり，以下の行為をしてはなりません。</p>
                        <ol className='mt-4 fs-5'>
                        ...
                        {/* <!-- ########## 第６条 ########## --> */}
                        <h1 className='text-center pt-5'>第６条（本サービスの提供の停止等）</h1>
                        <ol className='mt-4 fs-5'>
                        ...
                        {/* <!-- ########## 第７条 ########## --> */}
                        <h1 className='text-center pt-5'>第７条（著作権）</h1>
                        <ol className='mt-4 fs-5'>
                        ...
                        <li>
                            前項本文の定めるものを除き，本サービスおよび本サービスに関連する一切の情報についての著作権およびその他の知的財産権はすべて当社
                            または当社にその利用を許諾した権利者に帰属し，ユーザーは無断で複製，譲渡，貸与，翻訳，改変，転載，公衆送信（送信可能化を含みます。），伝送，配布，出版，営業使用等を
                            してはならないものとします。
                        </li>
                        </ol>
                        {/* <!-- ########## 第８条 ########## --> */}
                        <h1 className='text-center pt-5'>第８条（利用制限および登録抹消）</h1>
                        <ol className='mt-4 fs-5'>
                        <li>
                            当社は，ユーザーが以下のいずれかに該当する場合には，事前の通知なく，投稿データを削除し，ユーザーに対して本サービスの全部もしくは
                        ...
                        {/* <!-- ########## 第９条 ########## --> */}
                        <h1 className='text-center pt-5'>第９条（退会）</h1>
                        <p className='text-center mt-4'>ユーザーは，当社の定める退会手続により，本サービスから退会できるものとします。</p>
                        {/* <!-- ########## 第１０条 ########## --> */}
                        <h1 className='text-center pt-5'>第１０条（保証の否認および免責事項）</h1>
                        <ol className='mt-4 fs-5'>
                        <li>
                        ...
                        {/* <!-- ########## 第１１条 ########## --> */}
                        <h1 className='text-center pt-5'>第１１条（サービス内容の変更等）</h1>
                        <p className='text-center mt-4'>当社は，ユーザーへの事前の告知をもって、本サービスの内容を変更、追加または廃止することがあり、ユーザーはこれを承諾するものとします。</p>
                        {/* <!-- ########## 第１２条 ########## --> */}
                        <h1 className='text-center pt-5'>第１２条（利用規約の変更）</h1>
                        <ol className='mt-4 fs-5'>
                        ...
                        {/* <!-- ########## 第１３条 ########## --> */}
                        <h1 className='text-center pt-5'>第１３条（個人情報の取扱い）</h1>
                        <p className='text-center mt-4'>当社は，本サービスの利用によって取得する個人情報については，当社「プライバシーポリシー」に従い適切に取り扱うものとします。</p>
                        {/* <!-- ########## 第１４条 ########## --> */}
                        <h1 className='text-center pt-5'>第１４条（通知または連絡）</h1>
                        ...
                        {/* <!-- ########## 第１５条 ########## --> */}
                        <h1 className='text-center pt-5'>第１５条（権利義務の譲渡の禁止）</h1>
                        <p className='text-center mt-4'>ユーザーは，当社の書面による事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。</p>
                        {/* <!-- ########## 第１６条 ########## --> */}
                        <h1 className='text-center pt-5'>第１６条（準拠法・裁判管轄）</h1>
                        <ol className='mt-4 fs-5'>
                        <li>本規約の解釈にあたっては，日本法を準拠法とします。</li>
                        <li>本サービスに関して紛争が生じた場合には，当社の本店所在地を管轄する裁判所を専属的合意管轄とします。</li>
                        </ol>
                        <p className='position-absolute bottom-0 end-50'>以上</p>
                    </div>
                </div>
            </div>
        </div>
